# ══════════════════════════════════════════════════════════════════════
# ║  CONTROLE POR PERMUTAÇÃO (versão VS Code)                           ║
# ║  Variante Windows do controle_permutacao.py                         ║
# ║  Leandro Miguel — ORCID: 0009-0003-4655-472X                         ║
# ║  github.com/Leandro-VPN/universo-harmonico                           ║
# ══════════════════════════════════════════════════════════════════════

CONTROLE POR PERMUTAÇÃO — verificar artefato vs estrutura temporal
===================================================================
Se o espectro Rayleigh do v7 é artefato da distribuição dos valores,
então embaralhar os Δt deve dar o mesmo espectro.

Três controles:
  1. dt_perm = np.random.permutation(dt)    — mesmos valores, ordem aleatória
  2. dt_norm = np.random.normal(med, std, N) — mesma distribuição gaussiana
  3. dt_slot = gerado por combinação aleatória de slots A e B

Se espectro(original) ≈ espectro(permutado) → é artefato da distribuição.
Se espectro(original) ≠ espectro(permutado) → há estrutura temporal real.
"""
